...
class day17TestCase(unittest.TestCase):
    ...
    # def test_countWaterTiles_should_return_29(self):
    #     """Test for countWaterTiles"""
    #     ground = initializeGround(self.input0)
    #     result, _ = countWaterTiles(ground, (500, 0), True)
    ...
    # def test_countWaterTiles_should_return_114(self):
    #     """Test for countWaterTiles"""
    #     ground = initializeGround(self.input7)
    #     result, _ = countWaterTiles(ground, (500, 0))
    #     self.assertEqual(114, result)

    def test_countWaterTiles_should_return_186(self):
        """Test for countWaterTiles"""
        ground = initializeGround(self.input8)
        result, _ = countWaterTiles(ground, (500, 0))
        self.assertEqual(186, result)
