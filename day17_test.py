...
class day17TestCase(unittest.TestCase):
    ...
    def test_countWaterTiles_should_return_17(self):
        """Test for countWaterTiles"""
        ground = initializeGround(self.input5)
        result, _ = countWaterTiles(ground, (500, 0))
        self.assertEqual(17, result)

    def test_countWaterTiles_should_return_94(self):
        """Test for countWaterTiles"""
        ground = initializeGround(self.input6)
        result, _ = countWaterTiles(ground, (500, 0))
        self.assertEqual(94, result)

    def test_countWaterTiles_should_return_96(self):
        """Test for countWaterTiles"""
        ground = initializeGround(self.input7)
        result, _ = countWaterTiles(ground, (500, 0))
        self.assertEqual(96, result)

    def test_countWaterTiles_should_return_162(self):
        """Test for countWaterTiles"""
